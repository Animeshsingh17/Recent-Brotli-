...
import { UserConnectionRoutingModule } from './user-connection-routing.module';
...
import { DeleteDialogsComponentModule } from 'src/app/pages/universal-component/delete-dialogs-component/delete-dialogs-component.module';
import {AddUserConnectionModule} from '../add-user-connection/add-user-connection.module';
@NgModule({
  declarations: [UserConnectionComponent],
  imports: [
    CommonModule,
    UserConnectionRoutingModule,
    FlexLayoutModule,
