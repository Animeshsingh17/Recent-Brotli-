...
import { ActivityResponseBodyComponent } from './activity-response-body/activity-response-body.component';
...
export class ActivityComponent extends AppComponentBase implements OnInit, AfterViewInit {
